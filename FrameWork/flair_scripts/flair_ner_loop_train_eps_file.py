...
#train_file = os.path.join(args.data_folder_prefix, args.folder_name, args.train_file)
...
tagger: SequenceTagger = WeightedSequenceTagger(hidden_size=100,
...
if args.include_weight:
    data_folder = os.path.join(data_fold, str(args.train_file))
